...
export default function Page() {
  ...
  return (
    <div className="max-w-md mx-auto py-10 px-4">
      ...
      <p className="text-gray-500 text-center mb-6">For denne demoen støtter vi kun innlogging via Vipps.</p>
      ...
      <div className="bg-white p-6 rounded-xl shadow space-y-6">
        ...
        <div>
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-3 p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition"
              ...
              />
              <div>
                <div className="font-semibold text-gray-900">👷 Jobbsøker</div>
            ...
            <label className="flex items-center gap-3 p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition"
              ...
              />
              <div>
                <div className="font-semibold text-gray-900">💼 Arbeidsgiver</div>
        ...
        <a href={vippsHref}>
          <Button className="w-full h-11 text-base font-semibold">
            Logg inn som {role === "employer" ? "arbeidsgiver" : "jobbsøker"}
          </Button>
        </a>
